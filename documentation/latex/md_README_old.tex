...
\doxysection*{Approaches}

The problem is approached via data driven analysis. At the start of the project, we plan on collecting any data we can find on the energy consumption of data centres and internet infrastructure or internet traffic. We will also gather information on the current greenhouse gas emissions for power generation, as well as the historical development of greenhouse gas emissions for individual countries. Combined with the data on web traffic and its increase due to C\+O\+V\+I\+D-\/19, a variety of machine learning models will be trained to predict the increase in emissions during the pandemic. Future emission predictions will rely on forecasts about the course of the pandemic, or will be predictively generated based on past data. For the web interface, we plan on using the Chart.\+js framework to create a visually appealing and interactive environment.

\doxysection*{\+\_\+\+\_\+\+Current Project Status\+\_\+\+\_\+}

{\bfseries{Share\+La\+TeX\+:}} \href{https://sharelatex.tum.de/project/5f2d5db52dcb1012e4af42eb}{\texttt{ Click Here}}

{\bfseries{Last team session\+:}} August 7 \textbackslash{} {\bfseries{Next team session\+:}} T\+BA

\mbox{\hyperlink{summary__milestone3__july__7_8md}{Meeting Summary \& Milestone 3 Objectives}} \textbackslash{} /documentation/\+Machine Learning \mbox{\hyperlink{MachineLearningModels_8md}{Models/\+Machine\+Learning\+Models.\+md}} \char`\"{}\+M\+L Candidate Model Overview\char`\"{} \textbackslash{} /documentation/\+Machine Learning \mbox{\hyperlink{GeneralStrategy_8md}{Models/\+General\+Strategy.\+md}} \char`\"{}\+General M\+L Strategy\char`\"{} \textbackslash{} \mbox{\hyperlink{research__question__adaptation_8md}{Updated Project Proposal}} 